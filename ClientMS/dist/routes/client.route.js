...
router.get("/user/:userId", client_controller_1.ClientController.getUserById);
router.get("/wallet/deposit/:walletId", client_controller_1.ClientController.getWalletDeposit);
